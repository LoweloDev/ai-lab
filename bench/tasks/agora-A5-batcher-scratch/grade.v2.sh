#!/usr/bin/env bash
# Staging-Grader v2 für agora-A5-batcher-scratch (Audit 24./25.08.2026, Patch-Pakete P1 + P8;
...
#     Damit kann das Apply-Skript die A5-Lesart umschalten (grade_test.v2-vertrag.go, P5).
set -euo pipefail
export LC_ALL=C

BENCH=/home/lowelodev/ai-lab/bench
TASK=agora-A5-batcher-scratch
PKG=internal/feed
MODPKG=agora-backend/internal/feed
TASKDIR=$BENCH/tasks/$TASK
PRISTINE=$BENCH/workspaces/$TASK/agora-backend
HIDDEN=${GRADE_HIDDEN:-grade_test.v2.go}
